 ...
 * <p>They should also extend the {@link AbstractAction} class, or any other core actions. As such, all guidelines in {@link ArkNovaAction} apply here as well.</p>
 */
public class ArkNovaExtendedSequenceAction extends AbstractAction implements IExtendedSequence {

    // The extended sequence usually keeps record of the player who played this action, to be able to inform the game whose turn it is to make decisions
    final int playerID;

    public ArkNovaExtendedSequenceAction(int playerID) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof ArkNovaAction;
    }
