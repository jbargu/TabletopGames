 ...
 */
public class ArkNovaComponent extends Component {
    public ArkNovaComponent(CoreConstants.ComponentType type, String name) {
        super(type, name);
    }

    protected ArkNovaComponent(CoreConstants.ComponentType type, String name, int componentID) {
     ...
     */
    @Override
    public ArkNovaComponent copy() {
        ArkNovaComponent copy = new ArkNovaComponent(type, componentName, componentID);
    ...
    public boolean equals(Object o) {
        ...
        return (o instanceof ArkNovaComponent) && super.equals(o);
    }
